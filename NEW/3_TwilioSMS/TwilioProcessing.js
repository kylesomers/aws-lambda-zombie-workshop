...
var API = {
    ...
    endpoint: process.env.endpoint, // ie: 'https://xxxxxxx.execute-api.us-east-1.amazonaws.com',
    endpointPath: process.env.apiPath   // /ZombieWorkshopStage/zombie/messages/message
};

var table = process.env.usersTable; 
var index = process.env.phoneIndex; 
